...
```bash
bindd = $mainMod SHIFT, G, exec, omarchy-gpu-menu
```

Or if your keyboard has a dedicated button for armory-crate or others for this (might have to change the number after XF68Launch, differs from laptop to laptop):
